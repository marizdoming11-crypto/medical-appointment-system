...
Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/admin/schedules/edit/{id}', [AdminController::class, 'editSchedule']);
    Route::post('/admin/schedules/edit/{id}', [AdminController::class, 'updateSchedule']);
    ...
    Route::get('/admin/appointments/status/{id}/{status}', [AdminController::class, 'updateAppointmentStatus']);
...
Route::middleware(['user'])->group(function () {
    ...
    Route::get('/user/appointments/edit/{id}', [UserController::class, 'editAppointment']);
    Route::post('/user/appointments/edit/{id}', [UserController::class, 'updateAppointment']);
